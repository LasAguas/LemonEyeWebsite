const socials = [
  ...
  { name: 'Instagram', img: 'Lemon Eye On Instagram.png', url: 'https://www.instagram.com/lemoneyeband/' },
  ...
  { name: 'YouTube', img: 'Lemon Eye On YouTube.png', url: 'https://www.youtube.com/@LemonEyeBand' },
]
  ...
  return `
    <footer class="site-footer">
      <div class="container">
        ...
        <div class="footer-col">
          <a href="/epk.html" class="footer-link">epk and press resources</a>
        </div>
